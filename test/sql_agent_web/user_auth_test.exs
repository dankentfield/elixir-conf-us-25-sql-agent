defmodule SqlAgentWeb.UserAuthTest do
  use SqlAgentWeb.ConnCase, async: true

  alias SqlAgent.Accounts
  alias SqlAgent.Accounts.Scope
  alias SqlAgentWeb.UserAuth

  import SqlAgent.AccountsFixtures

  @remember_me_cookie "_sql_agent_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SqlAgentWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
